...
class Routes(
  ...
  // @LINE:5
  HistoricDocumentRequestController_9: controllers.HistoricDocumentRequestController,
  // @LINE:7
  GuaranteeTransactionsController_8: controllers.GuaranteeTransactionsController,
  // @LINE:10
  CashTransactionsController_10: controllers.CashTransactionsController,
  // @LINE:13
  ...
  // @LINE:20
  EORIHistoryRequestController_5: controllers.EORIHistoryRequestController,
  // @LINE:22
  SearchAuthoritiesController_13: controllers.SearchAuthoritiesController,
  // @LINE:24
  AuthoritiesCsvGenerationController_6: controllers.AuthoritiesCsvGenerationController,
  // @LINE:26
  SDESNotificationsController_12: controllers.SDESNotificationsController,
  // @LINE:30
  SubscriptionController_7: controllers.SubscriptionController,
  // @LINE:33
  ...
  val prefix: String
   ...
   def this(errorHandler: play.api.http.HttpErrorHandler,
    ...
    // @LINE:38
    FileUploadController_0: controllers.FileUploadController
  ) = this(errorHandler, CustomsAccountsController_4, HistoricDocumentRequestController_9, GuaranteeTransactionsController_8, CashTransactionsController_10, AccountAuthoritiesController_3, DutyDefermentContactDetailsController_1, EORIHistoryRequestController_5, SearchAuthoritiesController_13, AuthoritiesCsvGenerationController_6, SDESNotificationsController_12, SubscriptionController_7, Assets_11, TPIClaimsController_2, FileUploadController_0, "/")

  def withPrefix(addPrefix: String): Routes = {
    val prefix = play.api.routing.Router.concatPrefix(addPrefix, this.prefix)
    app.RoutesPrefix.setPrefix(prefix)
    new Routes(errorHandler, CustomsAccountsController_4, HistoricDocumentRequestController_9, GuaranteeTransactionsController_8, CashTransactionsController_10, AccountAuthoritiesController_3, DutyDefermentContactDetailsController_1, EORIHistoryRequestController_5, SearchAuthoritiesController_13, AuthoritiesCsvGenerationController_6, SDESNotificationsController_12, SubscriptionController_7, Assets_11, TPIClaimsController_2, FileUploadController_0, prefix)
  }
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """customs-financials-api/account-authorities""", """controllers.AccountAuthoritiesController.get()"""),
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """customs-financials-api/eori/""" + "$" + """eori<[^/]+>/validate""", """controllers.EORIHistoryRequestController.validateEORI(eori:models.EORI)"""),
  ...
  private[this] lazy val controllers_HistoricDocumentRequestController_makeRequest1_invoker = createInvoker(
    HistoricDocumentRequestController_9.makeRequest(),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "app",
  ...
  private[this] lazy val controllers_GuaranteeTransactionsController_retrieveOpenGuaranteeTransactionsSummary2_invoker = createInvoker(
    GuaranteeTransactionsController_8.retrieveOpenGuaranteeTransactionsSummary(),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "app",
  ...
  private[this] lazy val controllers_GuaranteeTransactionsController_retrieveOpenGuaranteeTransactionsDetail3_invoker = createInvoker(
    GuaranteeTransactionsController_8.retrieveOpenGuaranteeTransactionsDetail(),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "app",
      "controllers.GuaranteeTransactionsController",
  ...
  private[this] lazy val controllers_CashTransactionsController_getSummary4_invoker = createInvoker(
    CashTransactionsController_10.getSummary(),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "app",
  ...
  private[this] lazy val controllers_CashTransactionsController_getDetail5_invoker = createInvoker(
    CashTransactionsController_10.getDetail(),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "app",
      "controllers.CashTransactionsController",
      "getDetail",
  ...
  private[this] lazy val controllers_AccountAuthoritiesController_get6_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("customs-financials-api/account-authorities")))
  )
  private[this] lazy val controllers_AccountAuthoritiesController_get6_invoker = createInvoker(
    AccountAuthoritiesController_3.get(),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "app",
      ...
      Nil,
      "GET",
      this.prefix + """customs-financials-api/account-authorities""",
      """""",
      Seq()
    )
  )
  ...
  // @LINE:20
  private[this] lazy val controllers_EORIHistoryRequestController_validateEORI11_route = Route("GET",
  ...
  private[this] lazy val controllers_EORIHistoryRequestController_validateEORI11_invoker = createInvoker(
    EORIHistoryRequestController_5.validateEORI(fakeValue[models.EORI]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "app",
      "controllers.EORIHistoryRequestController",
      "validateEORI",
      Seq(classOf[models.EORI]),
      "GET",
  ...
  private[this] lazy val controllers_AuthoritiesCsvGenerationController_initiateAuthoritiesCsvGeneration13_invoker = createInvoker(
    AuthoritiesCsvGenerationController_6.initiateAuthoritiesCsvGeneration(),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "app",
  ...
  private[this] lazy val controllers_SubscriptionController_getVerifiedEmail17_invoker = createInvoker(
    SubscriptionController_7.getVerifiedEmail(),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "app",
  ...
  private[this] lazy val controllers_SubscriptionController_getUnverifiedEmail18_invoker = createInvoker(
    SubscriptionController_7.getUnverifiedEmail(),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "app",
      "controllers.SubscriptionController",
      "getUnverifiedEmail",
  ...
  private[this] lazy val controllers_SubscriptionController_getEmail19_invoker = createInvoker(
    SubscriptionController_7.getEmail(),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "app",
      "controllers.SubscriptionController",
      "getEmail",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    case controllers_HistoricDocumentRequestController_makeRequest1_route(params@_) =>
      call { 
        controllers_HistoricDocumentRequestController_makeRequest1_invoker.call(HistoricDocumentRequestController_9.makeRequest())
      }
  
    // @LINE:7
    case controllers_GuaranteeTransactionsController_retrieveOpenGuaranteeTransactionsSummary2_route(params@_) =>
      call { 
        controllers_GuaranteeTransactionsController_retrieveOpenGuaranteeTransactionsSummary2_invoker.call(GuaranteeTransactionsController_8.retrieveOpenGuaranteeTransactionsSummary())
      }
  
    // @LINE:8
    case controllers_GuaranteeTransactionsController_retrieveOpenGuaranteeTransactionsDetail3_route(params@_) =>
      call { 
        controllers_GuaranteeTransactionsController_retrieveOpenGuaranteeTransactionsDetail3_invoker.call(GuaranteeTransactionsController_8.retrieveOpenGuaranteeTransactionsDetail())
      }
  
    // @LINE:10
    case controllers_CashTransactionsController_getSummary4_route(params@_) =>
      call { 
        controllers_CashTransactionsController_getSummary4_invoker.call(CashTransactionsController_10.getSummary())
      }
  
    // @LINE:11
    case controllers_CashTransactionsController_getDetail5_route(params@_) =>
      call { 
        controllers_CashTransactionsController_getDetail5_invoker.call(CashTransactionsController_10.getDetail())
      }
  
    // @LINE:13
    case controllers_AccountAuthoritiesController_get6_route(params@_) =>
      call { 
        controllers_AccountAuthoritiesController_get6_invoker.call(AccountAuthoritiesController_3.get())
      }
    ...
    // @LINE:20
    case controllers_EORIHistoryRequestController_validateEORI11_route(params@_) =>
      call(params.fromPath[models.EORI]("eori", None)) { (eori) =>
        controllers_EORIHistoryRequestController_validateEORI11_invoker.call(EORIHistoryRequestController_5.validateEORI(eori))
      }
    ...
    case controllers_AuthoritiesCsvGenerationController_initiateAuthoritiesCsvGeneration13_route(params@_) =>
      call { 
        controllers_AuthoritiesCsvGenerationController_initiateAuthoritiesCsvGeneration13_invoker.call(AuthoritiesCsvGenerationController_6.initiateAuthoritiesCsvGeneration())
      }
    ...
    case controllers_SubscriptionController_getVerifiedEmail17_route(params@_) =>
      call { 
        controllers_SubscriptionController_getVerifiedEmail17_invoker.call(SubscriptionController_7.getVerifiedEmail())
      }
  
    // @LINE:31
    case controllers_SubscriptionController_getUnverifiedEmail18_route(params@_) =>
      call { 
        controllers_SubscriptionController_getUnverifiedEmail18_invoker.call(SubscriptionController_7.getUnverifiedEmail())
      }
  
    // @LINE:32
    case controllers_SubscriptionController_getEmail19_route(params@_) =>
      call { 
        controllers_SubscriptionController_getEmail19_invoker.call(SubscriptionController_7.getEmail())
      }
