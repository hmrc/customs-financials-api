...
package controllers.javascript {
  ...
  // @LINE:20
  class ReverseSubscriptionDisplayRequestController(_prefix: => String) {
    ...
    def validateEORI: JavaScriptReverseRoute = JavaScriptReverseRoute(
      "controllers.SubscriptionDisplayRequestController.validateEORI",
      """
        function(eori0) {
  ...
  class ReverseAccountAuthoritiesController(_prefix: => String) {
    ...
    def get: JavaScriptReverseRoute = JavaScriptReverseRoute(
      ...
      """
        function(eori0) {
          return _wA({method:"GET", url:"""" + _prefix + { _defaultPrefix } + """" + "customs-financials-api/" + encodeURIComponent((""" + implicitly[play.api.mvc.PathBindable[models.EORI]].javascriptUnbind + """)("eori", eori0)) + "/account-authorities"})
        }
      """
    )
