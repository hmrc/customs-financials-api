...
class RequestSpec extends SpecBase {
  "apply" should {
    "create the object correctly" in new Setup {
      ...
      val actualRequestOb: Request = Request(histDocRequestSearch, EmailAddress(TEST_EMAIL), "Company Name")
  ...
  "getContents" should {
    ...
    "return C79Certificate for Welsh language" in new Setup {
      ...
      expectedRequest.content(1).body mustBe
        encodeToUTF8Charsets(c79CertificateBody("Company Name", dateRangeForWelsh, welshLangKey))
    }
    ...
    "return PostponedVATStatement for Welsh language" in new Setup {
      ...
      expectedRequest.content(1).body mustBe
        encodeToUTF8Charsets(postponedVATBody("Company Name", dateRangeForWelsh, welshLangKey))
    }
