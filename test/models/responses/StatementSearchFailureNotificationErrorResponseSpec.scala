...
class StatementSearchFailureNotificationErrorResponseSpec extends SpecBase {
    ...
    "create the object correctly with errorCode, errorMessage, source and sourceFaultDetail" +
      "when schema validator generates error for missing single field" in {
        ...
        val sourceFaultDetail = SourceFaultDetail(
          Seq("object has missing required properties ([StatementSearchFailureNotificationMetadata])")
        )

        val errorDetail = ErrorDetail(
          Utils.currentDateTimeAsRFC7231(LocalDateTime.now()),
          correlationId,
  ...
  trait Setup {
    ...
    val errorDetail1: ErrorDetail = ErrorDetail(
      "2019-08-16T18:15:41Z",
    ...
    val errorDetail2: ErrorDetail = ErrorDetail(
      "2019-08-16T18:15:41Z",
      "3jh1f6b3-f8b1-4f3c-973a-05b4720e",
      "400",
      "Bad request received",
    ...
    val errorDetailContainerOb: ErrorDetailContainer = ErrorDetailContainer(
      ErrorDetail(
