...
case class GetCashAccountTransactionListingResponse(
...
case class CashTransactionsResponseDetail(
  dailyStatements: Option[Seq[DailyStatementContainer]],
...
case class DailyStatementDetail(
  date: String,
