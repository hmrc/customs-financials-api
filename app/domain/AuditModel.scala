...
case class GrantAuthorityRequestAuditDetail(
  ownerEORI: EORI,
  authorisedEORI: EORI,
  action: String,
...
case class EditAuthorityRequestAuditDetail(
  ownerEORI: EORI,
  authorisedEORI: EORI,
  action: String,
...
case class AccountAuditDetail(accountType: AccountType, accountNumber: AccountNumber)
...
case class RevokeAuthorityRequestAuditDetail(
  ownerEORI: EORI,
  authorisedEORI: EORI,
  action: String,
  accountType: AccountType,
...
case class HistoricDocumentRequestAuditDetail(
  eori: EORI,
...
case class RequestAuthAuditDetail(
...
case class RequestAuthCSVAuditDetail(requestingEori: String, requestAcceptedDate: String)
